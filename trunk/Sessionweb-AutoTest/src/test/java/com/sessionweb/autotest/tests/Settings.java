...
public class Settings extends SessionWebTest {
    ...
    @Test
    public void addSprint() throws Exception {
        cs.cleanDb();
        cs.logIn(selenium);
    ...
    @Test
    public void addTeamSprint() throws Exception {
        cs.cleanDb();
        cs.logIn(selenium);
    ...
    @Test
    public void modulesActivatedAndDeactivated() throws Exception {
        cs.cleanDb();
        cs.logIn(selenium);
        //testdata
        selenium.click("url_newsession");
    ...
    @Test
    public void listSettingsDisplayMyOwnAndAllSessions() throws Exception {
        cs.cleanDb();
        cs.logIn(selenium);
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("input_title");
		selenium.type("input_title", "sdfg");
		selenium.click("//form[@id='sessionform']/table/tbody/tr/td/table/tbody/tr[3]/td[1]");
		selenium.click("//input[@value='Save']");
		selenium.waitForPageToLoad("30000");
		selenium.click("url_newsession");
		selenium.waitForPageToLoad("30000");
		selenium.type("input_title", "asdfdsafc");
		selenium.click("//input[@value='Save']");
		selenium.waitForPageToLoad("30000");
		selenium.click("url_settings");
		selenium.waitForPageToLoad("30000");
		...
		selenium.click("url_newsession");
		selenium.waitForPageToLoad("30000");
		selenium.type("input_title", "cvbnvcb");
		selenium.click("//input[@value='Save']");
		selenium.waitForPageToLoad("30000");
		selenium.click("url_newsession");
		selenium.waitForPageToLoad("30000");
		selenium.type("input_title", "tyuruytyu");
		selenium.click("//input[@value='Save']");
		selenium.waitForPageToLoad("30000");
		selenium.click("url_settings");
		selenium.waitForPageToLoad("30000");
		...
		selenium.click("url_listsettings");
		selenium.waitForPageToLoad("30000");
		selenium.select("changelistsettings_options", "label=My own sessions");
		selenium.click("//input[@value='Update']");
		selenium.waitForPageToLoad("30000");
		selenium.click("url_list");
		selenium.waitForPageToLoad("30000");
