...
CREATE  TABLE IF NOT EXISTS `sessionwebos`.`settings` (
  ...
  `project` VARCHAR(45) NOT NULL ,
  `wisemapping_url` VARCHAR(45) NULL ,
  `wisemapping_user` VARCHAR(45) NULL ,
  `wisemapping_password` VARCHAR(45) NULL ,
...
CREATE  TABLE IF NOT EXISTS `sessionwebos`.`mission_attachments` (
  ...
  `mission_attachmentscol` VARCHAR(45) NULL ,
  `mission_attachmentscol1` VARCHAR(45) NULL ,
  `mission_attachmentscol2` VARCHAR(45) NULL ,
...
CREATE  TABLE IF NOT EXISTS `sessionwebos`.`softwareuseautofetched` (
  ...
  `softwareuseautofetchedcol` VARCHAR(45) NULL ,
  `softwareuseautofetchedcol1` VARCHAR(45) NULL ,
  PRIMARY KEY (`id`) ,
