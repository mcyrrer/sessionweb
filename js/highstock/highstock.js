...
(function () {
    ...
    function H(a, b, c) {
        var d, e;
        if (ma(b))x(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (x(b) &&
    ...
    function M(a, b) {
        if (Va && b && b.opacity !== r)b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        z(a.style, b)
    }
    ...
    function Xa(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length)f = f.join(":"), g = /\.([0-9])/, h = K.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Wa(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = xa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function yb(a, b) {
        ...
        for (g = 0; g < c.length; g++)if (d = c[g], e = L[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + L[c[g + 1][0]]) / 2)break;
    ...
    function eb(a, b, c, d) {
        ...
        if (x(b)) {
            ...
            if (j >= L[Ya])i[Lb](j >= L[ya] ? 0 : k * V(i[zb]() / k));
            if (j >= L[ya])i[Mb](j >= L[fa] ? 0 : k * V(i[Ab]() / k));
            if (j >= L[fa])i[Bb](j >= L[La] ? 1 : k * V(i[Ma]() / k));
            ...
            b = 1;
            h = i[lb]();
            for (var d = i.getTime(), m = i[kb](), l = i[Ma](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)e.push(d), j === L[sa] ? d = mb(h + b * k, 0) : j === L[La] ? d = mb(h, m + b * k) : !g && (j === L[fa] || j === L[Ka]) ? d = mb(h, m, l + b * k * (j === L[fa] ? 1 : 7)) : (j <= L[ya] && d % L[fa] === i && (f[d] = fa), d += j * k), b++;
            e.push(d)
        }
    ...
    var r, G = document, X = window, O = Math, v = O.round, V = O.floor, pa = O.ceil, s = O.max, C = O.min, T = O.abs, ga = O.cos, ja = O.sin, bb = O.PI, pb = bb * 2 / 360, Ra = navigator.userAgent, Tb = X.opera, Va = /msie/i.test(Ra) && !Tb, qb = G.documentMode === 8, rb = /AppleWebKit/.test(Ra), sb = /Firefox/.test(Ra), tb = /(Mobile|Android|Windows Phone)/.test(Ra), Da = "http://www.w3.org/2000/svg", ca = !!G.createElementNS && !!G.createElementNS(Da, "svg").createSVGRect, bc = sb && parseInt(Ra.split("Firefox/")[1], 10) < 4, ha = !ca && !Va && !!G.createElement("canvas").getContext, cb, fb = G.documentElement.ontouchstart !== r, Ub = {}, Ib = 0, nb, K, xa, Pa, Jb, L, qa = function () {
    ...
    xa = function (a, b, c) {
        if (!x(b) || isNaN(b))return "Invalid date";
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b), e, f = d[Ab](), g = d[Cb](),
            h = d[Ma](), i = d[kb](), j = d[lb](), k = K.lang, m = k.weekdays, d = z({
                a: m[g].substr(0, 3),
                A: m[g],
                d: Ja(h),
                e: h,
    ...
    Q && Q.init.call(Q,
        Jb);
    var ub = F.adapterRun, cc = F.getScript, ua = F.inArray, n = F.each, Xb = F.grep, dc = F.offset, Ea = F.map, I = F.addEvent, W = F.removeEvent, D = F.fireEvent, Yb = F.washMouseEvent, Kb = F.animate, gb = F.stop, F = {
        enabled: !0,
        align: "center",
        x: 0,
        y: 15,
    ...
    Ba.prototype = {
        init: function (a, b) {
            ...
            if (ma(a))c = a, h === "circle" ? c = {
                x: "cx",
                y: "cy"
            }[c] || c : c === "strokeWidth" && (c = "stroke-width"), q = H(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (q = parseFloat(q)); else {
                for (c in a)if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                    e !== r && (d = e);
                    if (c === "d")d &&
                    d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0"); else if (c === "x" && h === "text")for (e = 0; e < g.childNodes.length; e++)f = g.childNodes[e], H(f, "x") === H(g, "x") && H(f, "x", d); else if (this.rotation && (c === "x" || c === "y"))o = !0; else if (c === "fill")d = i.color(d, g, c); else if (h === "circle" && (c === "x" || c === "y"))c = {
                        x: "cx",
                        y: "cy"
                    }[c] || c; else if (h === "rect" && c === "r")H(g, {
                        rx: d,
                        ry: d
                    }), j = !0; else if (c === "translateX" || c === "translateY" || c === "rotation" || c === "verticalAlign" || c === "scaleX" || c === "scaleY")j = o = !0; else if (c === "stroke")d =
                        i.color(d, g, c); else if (c === "dashstyle")if (c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid")d = ba; else {
                        if (d) {
                        ...
                        right: "end"
                    }[d]; else if (c === "title")e = g.getElementsByTagName("title")[0], e || (e = G.createElementNS(Da, "title"), g.appendChild(e)), e.textContent = d;
                    ...
                    if (m && /^(width|height|visibility|x|y|d|transform)$/.test(c))for (e = m.length; e--;)H(m[e], c, c === "height" ? s(d - (m[e].cutHeight || 0), 0) : d);
        ...
        css: function (a) {
            ...
            ha && b && delete a.width;
            if (Va && !ca)b && delete a.width, M(this.element, a); else {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    k = {};
                    if (y !== this.cTT) {
                        if (x(j))a.isSVG ? (u = Va ? "-ms-transform" : rb ? "-webkit-transform" : sb ? "MozTransform" : Tb ? "-o-transform" : "", k[u] = k.transform = "rotate(" + j + "deg)") : (o = j * pb, q = ga(o), o = ja(o), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", q, ", M12=", -o, ", M21=", o, ", M22=", q, ", sizingMethod='auto expand')"].join("") : ba), M(b, k);
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || ma(c))this.alignTo = d = c || "renderer", na(f, this), f.push(this), c = null
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    b = a.width;
                    c = a.height;
                    if (Va && e && e.fontSize === "11px" && c.toPrecision(3) === "22.7")a.height = c = 14;
                    if (d)a.width =
            ...
            if (c.handleZ)for (c = 0; c < e.length; c++)if (a = e[c], b = H(a, "zIndex"), a !== f && (A(b) > g || !x(g) && x(b))) {
                d.insertBefore(f, a);
                h = !0;
                break
            }
    ...
    Fa.prototype = {
        Element: Ba, init: function (a, b, c, d) {
            var e = location, f;
        ...
        destroy: function () {
            ...
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g,
                '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="([^"]+)"/, i = H(b, "x"), j = a.styles, k = j && j.width && A(j.width), m = j && j.lineHeight, l = f.length; l--;)b.removeChild(f[l]);
            ...
            n(e, function (e, f) {
                ...
                n(l, function (e) {
                    if (e !== "" || l.length === 1) {
                        ...
                        b.appendChild(n);
                        u++;
                        if (k)for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), E, B = []; e.length || B.length;)delete a.bBox, E = a.getBBox().width, o = E > k, !o || e.length === 1 ? (e = B, B = [], e.length && (n = G.createElementNS(Da, "tspan"), H(n, {
                            dy: m || 16,
                            x: i
                        }), p && H(n, "style", p), b.appendChild(n), E > k && (k = E))) : (n.removeChild(n.firstChild), B.unshift(e.pop())), e.length && n.appendChild(G.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        }, button: function (a, b, c, d, e, f, g) {
            var h = this.label(a, b, c, null, null, null, null, null, "button"), i = 0, j, k, m, l, o, a = {
                x1: 0,
                y1: 0, x2: 0, y2: 1
            }, e = w({
                "stroke-width": 1,
            ...
            if (h)g = this.path(h), z(g, {
                symbolName: a,
                x: b,
                y: c,
                width: d,
                height: e
            }), f && z(g, f); else if (i.test(a))k =
                function (a, b) {
                    a.element && (a.attr({
                        width: b[0],
                        height: b[1]
                    }), a.alignByTranslate || a.translate(v((d - b[0]) / 2), v((e - b[1]) / 2)))
                }, j = a.match(i)[1], a = Ub[j], g = this.image(j).attr({
                x: b,
                y: c
            ...
            if (g) {
                ...
                g === "radialGradient" && b && !x(c.gradientUnits) && (c = w(c, {
                    cx: b[0] - b[2] /
                    2 + c.cx * b[2], cy: b[1] - b[2] / 2 + c.cy * b[2], r: c.r * b[2], gradientUnits: "userSpaceOnUse"
                }));
                for (l in c)l !== "id" && o.push(l, c[l]);
                for (l in j)o.push(j[l]);
                o = o.join(",");
                ...
                if (a) {
                    if (b = a.div, !b) {
                        ...
                        n(d.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || aa(Oa, {className: H(a.element, "class")}, {
                                position: "absolute",
            ...
            function j() {
                ...
                if (A) {
                    if (!u)a = v(-y * ka), b = h ? -C : 0, q.box = u = d ? o.symbol(d, a, b, q.width, q.height) : o.rect(a, b, q.width, q.height, 0, vb[Wb]), u.add(q);
            ...
            function k() {
                ...
                c = h ? 0 : C;
                if (x(E) && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (E - p.width);
    ...
    cb = Fa;
    var hb, Y;
    if (!ca && !ha)Highcharts.VMLElement = Y = {
        init: function (a, b) {
            ...
            ma(a) && x(b) && (c = a, a = {}, a[c] = b);
            if (ma(a))c = a, q = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a)if (d = a[c], l = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                e !== r && (d = e);
                if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))k || (this.symbolAttr(a),
                    ...
                    e = d.length;
                    l = [];
                    for (var n; e--;)if (Ia(d[e]))l[e] = v(d[e] * 10) - 5; else if (d[e] === "Z")l[e] = "x"; else if (l[e] = d[e], d.isArc && (d[e] === "wa" || d[e] === "at"))n = d[e] === "wa" ? 1 : -1, l[e + 5] === l[e + 7] && (l[e + 7] -= n), l[e + 6] === l[e + 8] && (l[e + 8] -= n);
                    d = l.join(" ") || "x";
                    f.path = d;
                    ...
                    g[c] = d;
                    l = !0
                } else if (c === "zIndex")d && (g[c] = d), l = !0; else if (ua(c, ["x", "y", "width", "height"]) !== -1)this[c] = d, c === "x" || c === "y" ? c = {
                    x: "left",
                    y: "top"
                }[c] : d = s(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, l = !0; else if (c === "class" && h === "DIV")f.className = d; else if (c === "stroke")d = i.color(d, f, c), c = "strokecolor"; else if (c === "stroke-width" || c === "strokeWidth")f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Ia(d) && (d += "px"); else if (c === "dashstyle")(f.getElementsByTagName("stroke")[0] ||
                aa(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid", this.dashstyle = d, l = !0; else if (c === "fill")if (h === "SPAN")g.color = d; else {
                    if (h !== "IMG")f.filled = d !== ba ? !0 : !1, d = i.color(d, f, c, this), c = "fillcolor"
                } else if (c === "opacity")l = !0; else if (h === "shape" && c === "rotation")this[c] = d, f.style.left = -v(ja(d * pb) + 1) + "px", f.style.top = v(ga(d * pb)) + "px"; else if (c === "translateX" || c === "translateY" || c === "rotation")this[c] = d, this.updateTransform(), l = !0; else if (c === "text")this.bBox = null, f.innerHTML = d, l = !0;
                l || (qb ? f[c] = d : H(f, c,
                    d))
            }
            return q
        ...
        Element: Y, isIE8: Ra.indexOf("MSIE 8.0") > -1, init: function (a, b, c) {
            var d, e;
            this.alignedObjects = [];
            ...
            this.boxWrapper =
                d;
            this.setSize(b, c, !1);
            if (!G.namespaces.hcv)G.namespaces.add("hcv", "urn:schemas-microsoft-com:vml"), G.createStyleSheet().cssText = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } "
        }, isHidden: function () {
            ...
            if (i) {
                ...
                if (c === "fill")if (i === "gradient")c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, o = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, y = 'angle="' + (90 - O.atan((l - a) / (o - c)) * 180 / bb) + '"', E();
                else {
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = va(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], aa(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
        ...
        circle: function (a, b, c) {
            ...
            if (da(a))b = a.y, c = a.width, d = a.height, f = a.strokeWidth, a = a.x;
    ...
    var Zb;
    if (ha)Highcharts.CanVGRenderer = Y = function () {
    ...
    ab.prototype = {
        addLabel: function () {
            ...
            g = z(g, h.style);
            if (x(e))e && e.attr({text: b}).css(g); else {
                d = {align: h.align};
                if (Ia(h.rotation))d.rotation = h.rotation;
        ...
        getLabelSize: function () {
            ...
            if (l && t)s === "inside" && (t = -t), d.opposite && (t = -t), b = this.getMarkPath(x, S, t, l * v, g, f), o ? o.animate({
                d: b,
                opacity: c
            }) : this.mark = f.path(b).attr({stroke: y, "stroke-width": l, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(x))i.xy = S = this.getLabelPosition(x, S, i, g, k, B, a, $), this.isFirst && !p(e.showFirstLabel, 1) || this.isLast && !p(e.showLastLabel, 1) ? E = !1 : !w && g && k.overflow === "justify" && !this.handleOverflow(a, S) && (E = !1), $ && a % $ && (E = !1), E && !isNaN(S.y) ? (S.opacity = c, i[this.isNew ? "attr" : "animate"](S), this.isNew = !1) :
                i.attr("y", -9999)
        }, destroy: function () {
            za(this, this.axis)
        }
    ...
    Db.prototype = {
        render: function () {
            ...
            if (h) {
                if (q = b.getPlotLinePath(m, h), d = {stroke: u, "stroke-width": h}, l)d.dashstyle = l
            } else if (k) {
            ...
            if (o)q ? o.animate({d: q}, null, o.onGetPath) : (o.hide(), o.onGetPath = function () {
                o.show()
            }); else if (q && q.length && (a.svgElem = o = r.path(q).attr(d).add(), y))for (n in e = function (b) {
                o.on(b, function (c) {
                    y[b].apply(a, [c])
                })
            }, y)e(n);
    ...
    Sb.prototype = {
        destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(this.percent ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = T(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {
                x: e ? f ? g : g - c : h,
                y: e ? i - h - b : f ? i - g - c : i - g,
                width: e ? c : b,
                height: e ? b : c
            };
            if (e = this.label)e.align(this.alignOptions, null, f), f = e.alignAttr,
    ...
    Ca.prototype = {
        ...
        init: function (a, b) {
            ...
            for (f in d)I(this,
                f, d[f]);
            if (this.isLog)this.val2lin = ra, this.lin2val = la
        },
        ...
        defaultLabelFormatter: function () {
            ...
            if (h)g = Xa(h, this); else if (c)g = b; else if (d)g = xa(d, b); else if (f && a >= 1E3)for (; f-- &&
                                                                                                            g === r;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Wa(b / c, -1) + e[f]);
        ...
        getSeriesExtremes: function () {
            ...
            n(a.series, function (g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isLog && v <= 0)v = j.threshold = null;
                    if (a.isXAxis) {
                        if (j = g.xData, j.length)a.dataMin = C(p(a.dataMin,
                        ...
                        if (k)q = j.stack, o = g.type + p(q, ""), n = "-" + o, g.stackKey = o, m = d[o] || [], d[o] = m, l = e[n] || [], e[n] = l;
                        ...
                        for (h = 0; h < $; h++) {
                            t = j[h];
                            y = u[h];
                            if (k)w = (S = y < v) ? l : m, J = S ? n : o, x(w[t]) ? (w[t] = oa(w[t] + y), y = [y, w[t]]) : w[t] = y, c[J] || (c[J] = {}), c[J][t] || (c[J][t] = new Sb(a, a.options.stackLabels,
                                S, t, q, k)), c[J][t].setTotal(w[t]), c[J][t].touched = f;
                            if (y !== null && y !== r && (!a.isLog || y.length || y > 0))if (I && (y = g.modifyValue(y)), g.getExtremesFromAll || z || (j[h + 1] || t) >= A.min && (j[h - 1] || t) <= A.max)if (t = y.length)for (; t--;)y[t] !== null && (E[B++] = y[t]); else E[B++] = y
                        }
                        if (!a.usePercentage && E.length)g.dataMin = k = Na(E), g.dataMax = g = ta(E), a.dataMin = C(p(a.dataMin, k), k), a.dataMax = s(p(a.dataMax, g), g);
                        if (x(v))if (a.dataMin >= v)a.dataMin = v, a.ignoreMinPadding = !0; else if (a.dataMax < v)a.dataMax = v, a.ignoreMaxPadding = !0
                    }
                }
            });
            for (g in c)for (h in c[g])c[g][h].touched <
        ...
        getLogTickPositions: function (a, b, c, d) {
            ...
            if (a >= 0.5)a = v(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = V(b), h, i, j, k, m, e = a > 0.3 ? [1,
                2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                i = e.length;
                for (h = 0; h < i && !m; h++)j = ra(la(f) * e[h]), j > b && (!d || k <= c) && g.push(k), k > c && (m = !0), k = j
            } else if (b = la(b), c = la(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = xb(a, null, O.pow(10, V(O.log(a) / O.LN10))), g = Ea(this.getLinearTickPositions(a, b, c), ra), !d)this._minorAutoInterval = a / 5;
        ...
        getMinorTickPositions: function () {
            ...
            } else if (this.isDatetimeAxis && a.minorTickInterval === "auto")d = d.concat(eb(yb(c), this.min, this.max, a.startOfWeek)), d[0] < this.min && d.shift(); else for (b = this.min + (b[0] - this.min) % c; b <= this.max; b += c)d.push(b);
            return d
        },
        adjustForMinRange: function () {
            var a = this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, j;
            if (this.isXAxis &&
                this.minRange === r && !this.isLog)x(a.min) || x(a.max) ? this.minRange = null : (n(this.series, function (a) {
                i = a.xData;
        ...
        setTickPositions: function (a) {
            ...
            if (e)!a && C(b.min, p(b.dataMin, b.min)) <= 0 && Aa(10, 1), b.min = oa(ra(b.min)), b.max = oa(ra(b.max));
            ...
            if (!q && !b.usePercentage && !h && x(b.min) && x(b.max) && (c = b.max - b.min)) {
                if (!x(d.min) && !x(b.userMin) && k && (b.dataMin < 0 || !b.ignoreMinPadding))b.min -= c * k;
                if (!x(d.max) && !x(b.userMax) && j && (b.dataMax > 0 || !b.ignoreMaxPadding))b.max += c * j
            }
            ...
            if (!f && !e && (a = O.pow(10, V(O.log(b.tickInterval) / O.LN10)), !m))b.tickInterval = xb(b.tickInterval, null, a, d);
            ...
            if (!i)i = f ? (b.getNonLinearTimeTicks || eb)(yb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval,
        ...
        adjustTickAmount: function () {
            ...
            if (c && c[a] && !this.isDatetimeAxis && !this.categories && !this.isLinked && this.options.alignTicks !== !1) {
                ...
                if (e < a) {
                    for (; b.length < a;)b.push(oa(b[b.length - 1] + this.tickInterval));
                    this.transA *= (e - 1) / (a - 1);
                    this.max = b[b.length - 1]
                }
                if (x(d) && a !== d)this.isDirty = !0
            }
        },
        setScale: function () {
        ...
        getExtremes: function () {
            var a = this.isLog;
            return {
                min: a ? oa(la(this.min)) : this.min,
                max: a ? oa(la(this.max)) : this.max,
        ...
        getOffset: function () {
            ...
            if (b || a.isLinked)n(e, function (b) {
                ...
                if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] === q.align)N = s(f[a].getLabelSize(), N)
            }), a.staggerLines && (N += (a.staggerLines -
            1) * 16); else for (r in f)f[r].destroy(), delete f[r];
            if (o && o.text && o.enabled !== !1) {
                ...
                if (j)k = a.axisTitle.getBBox()[g ? "height" : "width"], l = p(o.margin, g ? 5 : 10), m = o.offset;
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite,
                h = this.offset, i = A(e.style.fontSize || 12), d = {
                    low: f + (a ? 0 : d),
                    middle: f + d / 2,
                    high: f + (a ? d : 0)
        ...
        render: function () {
            ...
            if (u || f)if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function (b) {
                    k[b] || (k[b] = new ab(a, b, "minor"));
                    t && k[b].isNew && k[b].render(null, !0);
                    k[b].render(null, !1, 1)
                }), g.length && (n(g.slice(1).concat([g[0]]), function (b, c) {
                    c = c === g.length - 1 ? 0 : c + 1;
                    if (!f || b >= a.min && b <= a.max)j[b] || (j[b] = new ab(a, b)), t && j[b].isNew && j[b].render(c, !0), j[b].render(c, !1, 1)
                }),
                q && a.min === 0 && (j[-1] || (j[-1] = new ab(a, -1, null, !0)), j[-1].render(-1))), o && n(g, function (b, c) {
                    if (c % 2 === 0 && b < a.max)m[b] || (m[b] = new Db(a)), s = b + q, $ = g[c + 1] !== r ? g[c + 1] + q : a.max, m[b].options = {
                        from: e ? la(s) : s,
                        to: e ? la($) : $,
                        color: o
            ...
            n([j, k, m], function (a) {
                var c, d, e = [], f = Pa ? Pa.duration || 500 : 0, g = function () {
                    for (d = e.length; d--;)a[e[d]] && !a[e[d]].isActive && (a[e[d]].destroy(),
                        delete a[e[d]])
                };
                for (c in a)if (!a[c].isActive)a[c].render(c, !1, 0), a[c].isActive = !1, e.push(c);
                a === m || !b.hasRendered || !f ? g() : f && setTimeout(g, f)
            });
            if (p)u = a.getLinePath(p), a.axisLine ? a.axisLine.animate({d: u}) : a.axisLine = c.path(u).attr({
                stroke: d.lineColor,
                "stroke-width": p,
                zIndex: 7
            ...
            if (l && l.enabled) {
                ...
                for (E in i)for (B in c = i[E], c)c[B].render(d)
            }
            a.isDirty = !1
        },
    ...
    Eb.prototype = {
        init: function (a, b) {
            ...
            e.label.attr(f);
            if (g && (T(a - f.x) > 1 || T(b - f.y) > 1))clearTimeout(this.tooltipTimeout),
            ...
            j === !1 || !h ? this.hide() : (this.isHidden && (gb(d), d.attr("opacity", 1).show()), d.attr({text: j}), m = e.borderColor || a.color || i.color || "#606060", d.attr({stroke: m}), this.updatePosition({
                plotX: f,
                plotY: g
            }), this.isHidden = !1);
            if (l) {
                l = ia(l);
                for (d = l.length; d--;)if (e = a.series[d ? "yAxis" : "xAxis"], l[d] && e)if (h = d ? p(a.stackY, a.y) : a.x, e.isLog && (h = ra(h)), e = e.getPlotLinePath(h, 1), this.crosshairs[d])this.crosshairs[d].attr({
                    d: e,
                    visibility: "visible"
                }); else {
                    h = {
                        "stroke-width": l[d].width ||
    ...
    ob.prototype = {
        init: function (a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (b.tooltip.enabled)a.tooltip = new Eb(a, b.tooltip);
            this.setDOMEvents()
        ...
        getCoordinates: function (a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                h =
                    c.length;
                for (i = 0; i < h; i++)if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k], b.series))b._dist = T(k - b.clientX), j = C(j, b._dist), e.push(b);
        ...
        reset: function (a) {
            ...
            if (a.type === "touchstart")n(f, function (a, b) {
                ...
                if (!m)b.selectionMarker = m = z({destroy: qa}, c.plotBox);
        ...
        drop: function (a) {
            ...
            if (b)M(b.container, {cursor: b._cursor}), b.cancelClick = this.hasDragged, b.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []
            ...
            a.cancelBubble = !0;
            if (!b.cancelClick)c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, z(c, {
                pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top +
                e + (f ? b.plotHeight - h : i)
            }), D(c.series, "click", z(a, {point: c})), c.firePointEvent("click", a)) : (z(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && D(b, "click", a))
    ...
    Fb.prototype = {
        init: function (a, b) {
            ...
            e && e.attr({stroke: h});
            if (f) {
                if (g)for (j in g = a.convertAttribs(g), g)d = g[j], d !== r && (i[j] = d);
                f.attr(i)
            }
            ...
            if (!p && (a.legendGroup = d.g("legend-item").attr({zIndex: 1}).add(b.scrollGroup), t.drawLegendSymbol(b, a), a.legendItem = p = d.text(e.labelFormat ? Xa(e.labelFormat, a) : e.labelFormatter.call(a),
                    m ? g + h : -h, b.baseline, v).css(w(a.visible ? i : j)).attr({
                        align: m ? "left" : "right",
                        zIndex: 2
                    }).add(a.legendGroup), (v ? p : a.legendGroup).on("mouseover", function () {
                    a.setState("hover");
                ...
                }), b.colorizeItem(a, a.visible), y && r))a.checkbox = aa("input", {
            ...
            if (f && b.itemX - n + e > (l || c.chartWidth - 2 * k - n))b.itemX = n, b.itemY += q + b.lastLineHeight + o, b.lastLineHeight = 0;
            ...
            d > c && (d = c);
            if (d > 0)b !== r && $a(b, this.chart), this.nav.attr({
                translateX: i,
                ...
                fill: d === c ? h : g
            }).css({cursor: d === c ? "default" : "pointer"}), e = -C(e * (d - 1), this.fullHeight - e + i) + 1, this.scrollGroup.animate({translateY: e}), f.attr({text: d + "/" + c}), this.currentPage = d, this.positionCheckboxes(e)
        }
    };
    Qa.prototype = {
        init: function (a, b) {
        ...
        isInsidePlot: function (a, b, c) {
            ...
            if (!c)this.loadingDiv = c = aa(Oa, {className: "highcharts-loading"}, z(d.style, {
                zIndex: 10,
                display: ba
            }), this.container), this.loadingSpan = aa("span", null, d.labelStyle, c);
            ...
            a ? b && (this.renderTo.appendChild(c), Za(b), delete this.renderToClone) :
                (c && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), M(b, {
                    ...
                    top: "-9999px",
                    display: "block"
                }), G.body.appendChild(b), c && b.appendChild(c))
        }, getContainer: function () {
            var a, b = this.options.chart, c, d, e;
            this.renderTo = a = b.renderTo;
            e = "highcharts-" + Ib++;
            if (ma(a))this.renderTo = a = G.getElementById(a);
            a || Aa(13, !0);
            ...
            this.resetMargins();
            e = this.axisOffset;
            if ((this.title || this.subtitle) && !x(this.optionsMarginTop))if (m = s(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !m.floating && !m.verticalAlign && m.y || 0))this.plotTop = s(this.plotTop,
                m + p(k.margin, 15) + b);
            if (f.display && !l.floating)if (u === "right") {
                if (!x(i))this.marginRight = s(this.marginRight, f.legendWidth - q + o + c)
            } else if (u === "left") {
                if (!x(h))this.plotLeft = s(this.plotLeft, f.legendWidth + q + o + a)
            } else if (t === "top") {
                if (!x(g))this.plotTop = s(this.plotTop, f.legendHeight + N + o + b)
            } else if (t === "bottom" && !x(j))this.marginBottom = s(this.marginBottom, f.legendHeight - N + o + d);
            ...
            if (x(a))d.chartWidth = e = s(0, v(a)), d.hasUserSize = !!e;
            if (x(b))d.chartHeight = f = s(0, v(b));
            ...
            this.clipBox = {
                x: c,
                y: d,
                width: V(this.plotSizeX - s(b, k[1]) / 2 - c),
                height: V(this.plotSizeY - s(b, k[2]) / 2 - d)
            };
            ...
            if (k)f ? f.animate(y) : this.plotBackground = b.rect(q, n, p, t, 0).attr({fill: k}).add().shadow(a.plotShadow);
            if (m)h ? h.animate(y) : this.plotBGImage = b.image(m, q, n, p, t).add();
            s ? s.animate({width: r.width, height: r.height}) : this.clipRect = b.clipRect(r);
            if (l)g ? g.animate(g.crisp(null, q, n, p, t)) : this.plotBorder = b.rect(q, n, p, t, 0, l).attr({
            ...
            n(["inverted", "angular", "polar"], function (g) {
                ...
                for (e = d && d.length; !f &&
                e--;)(c = P[d[e].type]) && c.prototype[g] && (f = !0);
                a[g] = f
            })
        }, render: function () {
    ...
    Ga.prototype = {
        init: function (a, b, c) {
            ...
            if (typeof a === "number" || a === null)b = {y: a}; else if (Ua(a)) {
                b = {};
                if (a.length > e) {
                    c = typeof a[0];
            ...
            c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function () {
                ...
                b || n(e.getSelectedPoints(), function (a) {
                    if (a.selected &&
                        a !== c)a.selected = a.options.selected = !1, d.options.data[ua(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect")
                })
            })
            ...
            if (!b || ua(this, b) === -1)this.firePointEvent("mouseOut"), this.setState(), a.hoverPoint =
                null
    ...
    Z.prototype = {
        ...
        getColor: function () {
            ...
            if (!e && !a.colorByPoint)x(b._colorIndex) ? a = b._colorIndex : (b._colorIndex = d.color, a = d.color++), e = c[a];
            this.color = e;
        ...
        getSymbol: function () {
            ...
            if (!this.symbol)x(a._symbolIndex) ? a = a._symbolIndex : (a._symbolIndex = c.symbol, a = c.symbol++),
                this.symbol = d[a];
            ...
            if (l > (d.turboThreshold || 1E3)) {
                ...
                if (Ia(f)) {
                    ...
                    for (i = 0; i < l; i++)j[i] = f,
                        k[i] = a[i], f += d;
                    this.xIncrement = f
                } else if (Ua(f))if (o)for (i = 0; i < l; i++)d = a[i], j[i] = d[0], k[i] = d.slice(1, o + 1); else for (i = 0; i < l; i++)d = a[i], j[i] = d[0], k[i] = d[1]
            } else for (i = 0; i < l; i++)if (a[i] !== r && (d = {series: this}, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = q ? this.toYData(d) : d.y, m[i] = d.z, h && d.name))h[i] = d.name;
        ...
        processData: function (a) {
            ...
            for (a = b.length - 1; a > 0; a--)if (d = b[a] - b[a - 1], d > 0 && (h === r || d < h))h = d;
            this.cropped = g;
            this.cropStart = e;
        ...
        generatePoints: function () {
            ...
            for (l = 0; l < g; l++)i = h + l, j ? m[l] = (new f).init(this, [d[l]].concat(ia(e[l]))) : (b[i] ? k = b[i] : a[i] !== r && (b[i] = k = (new f).init(this, a[i], d[l])), m[l] = k);
            if (b && (g !== (c = b.length) || j))for (l = 0; l < c; l++)if (l === h && !j && (l += g), b[l])b[l].destroyElements(), b[l].plotX = r;
            this.data = b;
            this.points = m
        },
        translate: function () {
            ...
            for (k = 0; k < g; k++) {
                ...
                if (e.isLog && o <= 0)j.y = o = null;
                j.plotX = c.translate(l, 0, 0, 0, 1, m);
                if (b && this.visible && n && n[l])q = n[l], n = q.total, q.cum = q = q.cum - o, o = q + o, i && (q =
        ...
        setTooltipPoints: function (a) {
            ...
            if (this.options.enableMouseTracking !== !1) {
                ...
                for (g = 0; g < a; g++) {
                    f = b[g];
                    c = b[g - 1] ? d + 1 : 0;
                    for (d = b[g + 1] ? s(0, V((f.clientX + (b[g + 1] ? b[g + 1].clientX : e)) / 2)) : e; c >= 0 && c <= d;)h[c++] = f
                }
        ...
        tooltipHeaderFormatter: function (a) {
            ...
            if (e && !c)for (g in L)if (L[g] >= d.closestPointRange) {
                c =
        ...
        animate: function (a) {
            ...
            if (e && !da(e))e = R[b.type].animation;
            h = "_sharedClip" + e.duration + e.easing;
            if (a)a = c[h], e = c[h + "m"], a || (c[h] = a = d.clipRect(z(f, {width: 0})), c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group.clip(a), b.markerGroup.clip(e), b.sharedClipKey = h; else {
        ...
        drawPoints: function () {
            ...
            if (m.enabled || this._hasPointMarkers)for (f = b.length; f--;)if (g =
                    b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = m.enabled && i.enabled === r || i.enabled, l = c.isInsidePlot(d, e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = p(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)k.attr({visibility: l ? ca ? "inherit" : "visible" : "hidden"}).animate(z({
                x: d - h,
                y: e - h
            }, k.symbolName ? {width: 2 * h, height: 2 * h} : {})); else {
                if (l && (h > 0 || j))g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h).attr(a).add(o)
        ...
        getAttribs: function () {
            var a = this, b = a.options, c = R[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color, h = {
                stroke: g,
                fill: g
            ...
            for (g = i.length; g--;) {
                ...
                if (h.options)for (o in m)x(c[m[o]]) && (f = !0);
                if (f) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
                    f = d.hover = d.hover || {};
                    if (!b.marker)f.color = va(f.color || h.color).brighten(f.brightness || e.brightness).get();
        ...
        update: function (a, b) {
            var c = this.chart, d = this.type, a = w(this.userOptions, {
                animation: !1,
                index: this.index,
        ...
        destroy: function () {
            ...
            n(["xAxis", "yAxis"], function (b) {
                if (i = a[b])na(i.series, a), i.isDirty = i.forceRedraw = !0
            });
            ...
            if (b.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(b), g = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", b.zIndex || 6), e = b, n(c, function (c) {
                ...
                if (j && !i)c.dataLabel = j.destroy(); else if (i) {
                    ...
                    b.style.color = p(b.color, b.style.color,
                        a.color, "black");
                    if (j)if (x(f))j.attr({text: f}), o = !1; else {
        ...
        alignDataLabel: function (a, b, c, d, e) {
            var f =
                this.chart, g = f.inverted, h = p(a.plotX, -999), a = p(a.plotY, -999), i = b.getBBox(), d = z({
                x: g ? f.plotWidth - a : h,
                y: v(g ? f.plotHeight - h : a),
                width: 0,
                height: 0
            }, d);
        ...
        drawGraph: function () {
            ...
            n(c, function (c, g) {
                var j = c[0], k = a[j];
                if (k)gb(k), k.animate({d: f}); else if (d && f.length) {
        ...
        clipNeg: function () {
            ...
            if (d && this.graph)d = pa(this.yAxis.len - this.yAxis.translate(a.threshold ||
        ...
        drawTracker: function () {
            ...
            if (j)j.attr({d: d}); else if (a.tracker = j = h.path(d).attr({
                ...
                }).css(k).add(a.markerGroup), fb)j.on("touchstart", o)
        }
    };
    F = ea(Z);
    P.line = F;
    ...
    F = ea(Z, {
        type: "area", getSegments: function () {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                b.length && a.push(b)
            } else Z.prototype.getSegments.call(this), a = this.segments;
            this.segments = a
        }, getSegmentPath: function (a) {
            ...
            n(d, function (d) {
                ...
                g ? g.animate({d: b}) : a[f] = a.chart.renderer.path(b).attr({
                    fill: p(d[2], va(d[1]).setOpacity(c.fillOpacity || 0.75).get()),
                    zIndex: 0
                }).add(a.group)
            })
    ...
    Y = ea(Z, {
        type: "column", tooltipOutsidePlot: !0, requireSorting: !1, pointAttrToOptions: {
            ...
            c.grouping === !1 ? i = 1 : n(b.series, function (b) {
                var c = b.options;
                if (b.type === a.type && b.visible && a.options.group === c.group)c.stacking ? (f = b.stackKey, g[f] === r && (g[f] = i++), h = g[f]) : c.grouping !== !1 && (h = i++), b.columnIndex = h
            });
        ...
        drawGraph: qa, drawPoints: function () {
            ...
            n(a.points, function (e) {
                ...
                if (f !== r && !isNaN(f) && e.y !== null)d = e.shapeArgs, g ? (gb(g), g.animate(w(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius); else if (g)e.graphic = g.destroy()
            })
        }, drawTracker: function () {
            var a = this, b = a.chart.pointer, c = a.options.cursor, d = c && {cursor: c}, e = function (b) {
                var c = b.target, d;
                for (a.onMouseOver(); c && !d;)d = c.point, c = c.parentNode;
                if (d !== r)d.onMouseOver(b)
            };
            ...
            if (ca)a ? (e.scaleY = 0.001, a = C(b.pos +
    ...
    Q = {
        ...
        translate: function (a) {
            ...
            for (q = 0; q < n; q++)p = k[q], b += o && !p.visible ? 0 : p.y;
            for (q = 0; q < n; q++) {
                p = k[q];
                d = b ? p.y / b : 0;
                g = v((j + c * m) * 1E3) / 1E3;
        ...
        drawDataLabels: function () {
            ...
            if (e.enabled || a._hasPointLabels) {
                ...
                for (A = 0; !x && b[A];)x = b[A] && b[A].dataLabel && (b[A].dataLabel.getBBox().height || 21), A++;
                for (A = 2; A--;) {
                    var b = [], L = [], G = w[A], F =
                        G.length, D;
                    H(G, A - 0.5);
                    if (m > 0) {
                        for (J = q - o - m; J <= q + o + m; J += x)b.push(J);
                        t = b.length;
                        if (F > t) {
                            c = [].concat(G);
                            c.sort(I);
                            for (J = F; J--;)c[J].rank = J;
                            for (J = F; J--;)G[J].rank >= t && G.splice(J, 1);
                            F = G.length
                        }
                        for (J = 0; J < F; J++) {
                            c = G[J];
                            ...
                            c = 9999;
                            var M, K;
                            for (K = 0; K < t; K++)M = T(b[K] - y[1]), M < c && (c = M, D = K);
                            if (D < J && b[J] !== null)D = J; else for (t < F - J + D && b[J] !== null && (D = t - F + J); b[D] === null;)D++;
                            L.push({i: D, y: b[D]});
                            b[D] = null
                        }
                        L.sort(I)
                    ...
                    for (J = 0; J < F; J++) {
                        ...
                        c = y[1];
                        if (m > 0) {
                            if (t = L.pop(), D = t.i, B = t.y, c > B && b[D + 1] !== null || c < B && b[D - 1] !== null)B = c
                        } else B = c;
                        ...
                        u.connX = E;
                        u.connY = B;
                        if (this.options.size === null)t = u.width, E - t < f ? C[3] = s(v(t - E + f), C[3]) : E + t > h - f && (C[1] = s(v(E + t - h + f), C[1])), B - x / 2 < 0 ? C[0] = s(v(-B + x / 2), C[0]) : B + x / 2 > d && (C[2] = s(v(B + x / 2 - d), C[2]))
                    }
                }
                if (ta(C) === 0 || this.verifyDataLabelOverflow(C))this.placeDataLabels(),
                r && g && n(this.points, function (b) {
                    i = b.connector;
                    y = b.labelPos;
                    if ((u = b.dataLabel) && u._pos)E = u.connX, B = u.connY, j = k ? ["M", E + (y[6] === "left" ? 5 : -5), B, "C", E, B, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", E + (y[6] === "left" ? 5 : -5), B, "L", y[2], y[3], "L", y[4], y[5]], i ? (i.animate({d: j}), i.attr("visibility", z)) : b.connector = i = a.chart.renderer.path(j).attr({
                        "stroke-width": g,
    ...
    Q = ea(Z, Q);
    P.pie = Q;
    var U = Z.prototype, ec = U.processData, fc = U.generatePoints, gc = U.destroy, hc = U.tooltipHeaderFormatter, ic = {
        approximation: "average",
        groupPixelWidth: 2,
        dateTimeLabelFormats: ib(jb, ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], db, ["%A, %b %e, %H:%M:%S", "%A, %b %e, %H:%M:%S", "-%H:%M:%S"], Ya, ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M",
            "-%H:%M"], ya, ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], fa, ["%A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y"], Ka, ["Week from %A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y"], La, ["%B %Y", "%B", "-%B %Y"], sa, ["%Y", "%Y", "-%Y"])
    }, $b = {
        line: {},
        spline: {},
        area: {},
    ...
    }, ac = [[jb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [db, [1, 2, 5, 10, 15, 30]], [Ya, [1, 2, 5, 10, 15, 30]], [ya, [1, 2, 3, 4, 6, 8, 12]], [fa, [1]], [Ka, [1]], [La, [1, 3, 6]], [sa, null]], Ha = {
        sum: function (a) {
            var b = a.length, c;
    ...
    U.groupData = function (a, b, c, d) {
        ...
        for (n = 0; n <= i; n++) {
            for (; c[1] !== r && a[n] >= c[1] || n === i;)if (j = c.shift(), k = d.apply(0, l), k !== r && (g.push(j), h.push(k)), l[0] = [], l[1] = [], l[2] = [], l[3] = [], n === i)break;
            if (n === i)break;
            if (o) {
                j = this.cropStart + n;
                j = e && e[j] || this.pointClass.prototype.applyOptions.apply({series: this}, [f[j]]);
                var p;
                for (k = 0; k < q; k++)if (p = j[o[k]], typeof p === "number")l[k].push(p); else if (p === null)l[k].hasNulls = !0
            } else if (j = m ? b[n] : null, typeof j === "number")l[0].push(j); else if (j === null)l[0].hasNulls = !0
        }
        return [g, h]
    };
    U.processData = function () {
        ...
        if (ec.apply(this, arguments) !== !1 && d) {
            ...
            if (!h.groupPixelWidth) {
                for (a = k.length; a--;)k[a].xAxis === h && k[a].options.dataGrouping && (i = s(i, k[a].options.dataGrouping.groupPixelWidth));
                h.groupPixelWidth =
                    i
            }
            if (j > g / i || j && c.forced) {
    ...
    U.tooltipHeaderFormatter = function (a) {
        ...
        if (f && f.options.type === "datetime" && c && Ia(a.key)) {
            ...
            if (g)f = c[g.unitName], g.count === 1 ? d = f[0] : (d = f[1], e = f[2]); else if (!d)for (h in L)if (L[h] >= f.closestPointRange) {
                d = c[h][0];
                break
            }
            d = xa(d, a.key);
    ...
    wa(U, "setOptions", function (a, b) {
        ...
        if ($b[d])f || (f = w(ic, $b[d])), c.dataGrouping = w(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
    ...
    Q = ea(P.column, {
        ...
        getAttribs: function () {
            ...
            for (d =
                     0; d < f; d++)if (c = e[d], b = d > 0 ? e[d - 1].close < c.close : c.open < c.close)c.pointAttr = a
        },
        translate: function () {
            var a = this.yAxis;
        ...
        drawPoints: function () {
            ...
            n(a.points, function (k) {
                if (k.plotY !== r)i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""], f = c["stroke-width"] % 2 / 2, j = v(k.plotX) + f, g = v(k.shapeArgs.width /
    ...
    Q = ea(Q, {
        ...
        upColorProp: "fill", drawPoints: function () {
            ...
            n(a.points, function (l) {
                j = l.graphic;
                if (l.plotY !== r)c = l.pointAttr[l.selected ? "selected" : ""], h = c["stroke-width"] % 2 / 2, i = v(l.plotX) + h, d = v(l.plotOpen) + h, e = v(l.plotClose) + h, f = O.min(d, e), g = O.max(d, e), m = v(l.shapeArgs.width / 2), k = ["M", i - m, g, "L", i - m, f, "L", i + m, f, "L", i + m, g, "L", i - m, g, "M", i, g, "L", i, v(l.yBottom), "M", i, f, "L", i, v(l.plotY), "Z"], j ? j.animate({d: k}) : l.graphic = b.renderer.path(k).attr(c).add(a.group)
            })
        }
    });
    P.candlestick = Q;
    ...
    P.flags = ea(P.column, {
        ...
        translate: function () {
            ...
            if (d && d.visible && h) {
                ...
                for (b.sort(function (a, b) {
                    ...
                    if (d.x <= m)d.plotY = k.plotY, k.x < d.x && !f && (l = g[h + 1]) && l.plotY !== r && (d.plotY += (d.x - k.x) / (l.x - k.x) * (l.plotY - k.plotY));
                    c--;
                    h++;
                    if (c < 0)break
                }
        ...
        drawPoints: function () {
            ...
            for (j = b.length; j--;)if (k = b[j], d = k.plotX + l, a = k.stackIndex, h = k.options.shape || f.shape, e = k.plotY, e !== r && (e = k.plotY + g + l - (a !== r && a * f.stackDistance)), i = a ? r : k.plotX + l, o = a ? r : k.plotY, m = k.graphic,
                e !== r)a = k.pointAttr[k.selected ? "select" : ""], m ? m.attr({
                x: d,
                y: e,
                r: a.r,
                anchorX: i,
                anchorY: o
            }) : m = k.graphic = c.label(k.options.title || f.title || "A", d, e, h, i, o, f.useHTML).css(w(f.style, k.style)).attr(a).attr({
                align: h === "flag" ? "left" : "center",
                width: f.width,
                height: f.height
            }).add(this.group).shadow(f.shadow), i = m.box, a = i.getBBox(), k.shapeArgs = z(a, {
    ...
    z(K, {
        navigator: {
            ...
            series: {
                ...
                compare: null,
                fillOpacity: 0.4,
                dataGrouping: {approximation: "average", groupPixelWidth: 2, smoothed: !0, units: F},
            ...
            minWidth: 6,
            rifleColor: "#666",
            trackBackgroundColor: ib("linearGradient", {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
    ...
    Gb.prototype = {
        drawHandle: function (a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (!this.rendered) {
                    if (E)this.navigatorGroup = m = f.g("navigator").attr({zIndex: 3}).add(), this.leftShade = f.rect().attr({fill: u.maskFill}).add(m), this.rightShade = f.rect().attr({fill: u.maskFill}).add(m), this.outline = f.path().attr({
                        "stroke-width": B,
                        stroke: u.outlineColor
                    }).add(m);
                    if (r)this.scrollbarGroup = k = f.g("scrollbar").add(),
                        l = t.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({
                        y: -l % 2 / 2,
                        ...
                        "stroke-width": G,
                        r: I
                    }).add(k), this.scrollbarRifles = f.path().attr({stroke: t.rifleColor, "stroke-width": 1}).add(k)
                }
                e = e.isResizing ? "animate" : "attr";
                E && (this.leftShade[e]({x: g, y: w, width: d, height: x}), this.rightShade[e]({
                    x: g + a,
                    y: w, width: h - a, height: x
                }), this.outline[e]({d: ["M", i, F, "L", g + d + z, F, g + d + z, F + J - n, "M", g + a - z, F + J - n, "L", g + a - z, F, i + j, F]}), this.drawHandle(d + z, 0), this.drawHandle(a + z, 1));
                if (r)this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({
                    translateX: i,
                    translateY: v(F + x)
                }), o[e]({width: j}), g = n + d, h = c - G, h < y && (D = (y - h) / 2, h = y, g -= D), this.scrollbarPad = D, l[e]({
                    x: V(g) + G % 2 / 2,
                    width: h
                }), y = n + d + c / 2 - 0.5, this.scrollbarRifles.attr({visibility: c > 12 ? "visible" : "hidden"})[e]({
                    d: ["M", y - 3, n / 4, "L", y - 3, 2 * n / 3, "M", y, n / 4, "L", y, 2 * n / 3, "M",
                        y + 3, n / 4, "L", y + 3, 2 * n / 3]
                });
                this.scrollbarPad = D;
                this.rendered = !0
            ...
            a.mouseDownHandler = function (d) {
                ...
                if (u > h && u < h + g + i)if ((h = !a.scrollbarEnabled || u < h + g) && O.abs(t -
                    e - n) < s)a.grabbedLeft = !0, a.otherHandlePos = f; else if (h && O.abs(t - f - n) < s)a.grabbedRight = !0, a.otherHandlePos = e; else if (t > n + e - q && t < n + f + q) {
                    a.grabbedCenter = t;
                    if (b.renderer.isSVG)l = m.cursor, m.cursor = "ew-resize";
                    j = t - e
                } else if (t > k && t < k + o && (f = h ? t - n - r / 2 : t < n ? e - C(10, r) : t > k + o - i ? e + C(10, r) : t < n + e ? e - r : f, f < 0 ? f = 0 : f + r > p && (f = p - r), f !== e)) {
                    a.fixedWidth = r;
                    if (!d.ordinalPositions)d.fixedRange = d.max - d.min;
                    e = c.translate(f, !0);
            ...
            a.mouseMoveHandler =
                function (c) {
                    ...
                    if (c.pageX !== 0)c = b.pointer.normalize(c), c = c.chartX, c < e ? c = e : c > g + h - d && (c = g + h - d), a.grabbedLeft ? (k = !0, a.render(0, 0, c - e, a.otherHandlePos)) : a.grabbedRight ? (k = !0, a.render(0, 0, a.otherHandlePos, c - e)) : a.grabbedCenter && (k = !0, c < j ? c = j : c > f + j - i && (c = f + j - i), a.render(0, 0, c - j, c - j + i)), k && a.scrollbarOptions.liveRedraw && setTimeout(function () {
                        a.mouseUpHandler(!1)
                    }, 0)
                };
            a.mouseUpHandler = function (d) {
                ...
                if (d !== !1)a.grabbedLeft = a.grabbedRight = a.grabbedCenter = k = j = null, m.cursor = l || ""
            };
            ...
            if (a.navigatorEnabled) {
                ...
                n = v.data;
                a.xAxis = c = new Ca(b, w({ordinal: o && o.xAxis.options.ordinal}, f.xAxis, {
                    isX: !0,
                    type: "datetime",
                    index: r,
                    height: g,
                ...
                r.data = n || y;
                i = b.initSeries(r);
                if (o && f.adaptToUpdatedData !== !1)I(o, "updatedData", a.updatedDataHandler), o.userOptions.events = z(o.userOptions.event, {updatedData: a.updatedDataHandler})
            } else a.xAxis = c = {
    ...
    wa(Ca.prototype, "zoom", function (a, b, c) {
        ...
        if (this.isXAxis && (g && g.enabled || e && e.enabled))if (f === "x")d.resetZoomButton = "blocked"; else if (f ===
            "y")h = !1; else if (f === "xy")d = this.previousZoom, x(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
    ...
    z(K, {
        rangeSelector: {
            buttonTheme: {width: 28, height: 16, padding: 1, r: 0, stroke: "#68A", zIndex: 7},
    ...
    Hb.prototype = {
        clickButton: function (a, b, c) {
            var d = this, e = d.chart, f = d.buttons, g = e.xAxis[0], h = g && g.getExtremes(), i = e.scroller && e.scroller.xAxis, j = i && i.getExtremes && i.getExtremes(), i = j && j.dataMin, j = j && j.dataMax, k = h && h.dataMin, m = h && h.dataMax, l = (x(k) && x(i) ? C : p)(k, i), o = (x(m) && x(j) ? s : p)(m, j), q, h = g && C(h.max, o), i = new Date(h), j = b.type, k = b.count, v, u, m = {
                millisecond: 1,
                second: 1E3,
                minute: 6E4,
                hour: 36E5,
            ...
            if (!(l ===
                ...
                if (m[j])v = m[j] * k, q = s(h - v, l); else if (j === "month")i.setMonth(i.getMonth() - k), q = s(i.getTime(), l), v = 2592E6 * k; else if (j === "ytd")if (g) {
                    if (o === r)l = Number.MAX_VALUE, o = Number.MIN_VALUE, n(e.series, function (a) {
                        a = a.xData;
                        l = C(a[0], l);
                        o = s(a[a.length - 1], o)
                    }), c = !1;
                    ...
                    return
                } else j === "year" ? (i.setFullYear(i.getFullYear() - k), q = s(l, i.getTime()), v =
                    31536E6 * k) : j === "all" && g && (q = l, h = o);
                f[a] && f[a].setState(2);
                g ? g.setExtremes(q, h, p(c, 1), 0, {
                    trigger: "rangeSelectorButton",
                    rangeSelectorButton: b
                }) : (c = e.options.xAxis, c[0] = w(c[0], {range: v, min: u}));
                d.selected = a
            }
        },
        ...
        drawInput: function (a) {
            ...
            m.offset +=
                j.width + 5;
            this[a + "DateBox"] = k = e.label("", m.offset).attr({
                padding: 1,
                width: 90,
                height: 16,
                stroke: "silver",
                "stroke-width": 1
            }).css(w({textAlign: "center"}, d, f.inputStyle)).on("click", function () {
                b[a + "Input"].focus()
            }).add(m);
            ...
            i.onchange = function () {
                ...
                if (!isNaN(d) && (K.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4), h && d >= e.dataMin && d <= b.maxInput.HCTime || !h && d <= e.dataMax && d >=
                    b.minInput.HCTime))c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, r, r, {trigger: "rangeSelectorInput"})
            }
        },
        render: function (a, b) {
            ...
            if (!c.rendered && (c.zoomText = e.text(k.rangeSelectorZoom, r, d.plotTop - 10).css(i.labelStyle).add(), u = r + c.zoomText.getBBox().width + 5, n(c.buttonOptions,
                    ...
                    }), o))c.div = m = aa("div", null, {
                position: "relative",
                height: 0,
                zIndex: 1
            }), f.parentNode.insertBefore(m, f), c.inputGroup = m = e.g("input-group").add(), m.offset = 0, c.drawInput("min"), c.drawInput("max");
            o && (f = d.plotTop - 35, m.align(z({
                y: f, width: m.offset, x: h && f < (h.y || 0) + h.height - g.chart.spacingTop ?
                    -40 : 0
        ...
        destroy: function () {
            ...
            for (e in this)this[e] && e !== "chart" && (this[e].destroy ? this[e].destroy() : this[e].nodeType && Za(this[e])), this[e] = null
        }
    };
    wa(Qa.prototype, "init", function (a, b, c) {
        I(this, "init",
    ...
    Highcharts.StockChart = function (a, b) {
        var c = a.series, d, e = {
            ...
            states: {hover: {lineWidth: 2}}
        }, f = {shadow: !1, borderWidth: 0};
        a.xAxis = Ea(ia(a.xAxis || {}), function (a) {
            return w({
                minPadding: 0, maxPadding: 0, ordinal: !0, title: {text: null}, labels: {overflow: "justify"},
                showLastLabel: !0
        ...
        a.yAxis = Ea(ia(a.yAxis || {}), function (a) {
            d = a.opposite;
            return w({
                labels: {align: d ? "right" : "left", x: d ? -2 : 2, y: -2},
                showLastLabel: !1,
                title: {text: null}
            }, a)
        });
        ...
        a = w({
            ...
            legend: {enabled: !1},
            plotOptions: {
                line: e, spline: e, area: e, areaspline: e, arearange: e, areasplinerange: e, column: f, columnrange: f,
                candlestick: f, ohlc: f
            }
            ...
            if (d && d.options.ordinal && !d.hasOrdinalExtension) {
                ...
                d.lin2val = function (a, b) {
                    ...
                    if (c) {
                        ...
                        if (b)a < 0 ? a = c[0] : a > k ? a = c[k] : (k = V(a), l = a - k); else for (; k--;)if (m = d * k + e, a >= m) {
                            d = d * (k + 1) + e;
                            l = (a - m) / (d - m);
                            break
                        }
                ...
                d.getNonLinearTimeTicks = function (a, b, c, e, j, k, m) {
                    ...
                    if (!j || j.length === 1 || b === r)return eb(a, b, c, e);
                    for (t = j.length; n < t; n++) {
                        v = n && j[n - 1] > c;
                        j[n] < b && (l = n);
                        if (n === t - 1 || j[n + 1] - j[n] > k * 5 || v) {
                            if (j[n] > z) {
                                for (p = eb(a, j[l], j[n], e); p.length && p[0] <= z;)p.shift();
                    ...
                    if (m && a.unitRange <= L[ya]) {
                        n = w.length - 1;
                        for (l = 1; l < n; l++)(new Date(w[l]))[Ma]() !== (new Date(w[l - 1]))[Ma]() && (s[w[l]] = fa, u = !0);
                        u && (s[w[0]] = fa);
                        a.higherRanks = s
                    }
                    w.info = a;
                    if (m && x(A)) {
                        ...
                        u < A * 0.6 && (u = null);
                        m = w[a - 1] > c ? a - 1 : a;
                        for (B = void 0; m--;)l = n[m], c = B - l, B && c < A * 0.8 && (u === null || c < u * 0.8) ? (s[w[m]] && !s[w[m + 1]] ? (c = m + 1, B = l) : c = m, w.splice(c, 1)) : B = l
                    }
                    return w
                };
                var e = b.pan;
