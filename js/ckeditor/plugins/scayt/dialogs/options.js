    ...
    },
        {
            ...
            elements: [{
                ...
                children: [{
                    ...
                    html: '<form><div style="float:left;width:45%;margin-left:5px;" id="left-col-' + f.name + '"></div><div style="float:left;width:45%;margin-left:15px;" id="right-col-' + f.name + '"></div></form>',
                    onShow: function () {
