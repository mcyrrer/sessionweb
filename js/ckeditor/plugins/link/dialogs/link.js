            ...
            title: b.title, minWidth: 350, minHeight: 230, contents: [{
                id: "info", label: b.info, title: b.info, elements: [{
                    ...
                    type: "vbox", id: "emailOptions", padding: 1, children: [{
                        ...
                        label: b.emailAddress, required: !0, validate: function () {
                            var a = this.getDialog();
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        label: b.targetFrameName, "default": "", setup: function (a) {
                ...
                var a =
                    this.getParentEditor(), b = a.getSelection(), c = null;
                ...
                if (this._.selectedElement) {
                    ...
                    if (d == f || "email" == a.type && -1 !=
                        f.indexOf("@"))e.setHtml("email" == a.type ? a.email.address : c.set["data-cke-saved-href"]), b.selectElement(e);
