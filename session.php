...
function echoSessionlinkEdit($versionid)
{
    ...
    if($versionid!="")
    {
        ...
        $rowSessionSessionlink = getSessionSessionlink($versionid);
        ...
        {
            echo "              var mySessionlink = new Array(\"$mySessionlinkArray\");\n";
        }
        else
        {
        ...
        if($rowSessionSessionlink!="")
        {
            foreach($rowSessionSessionlink as $row)
            {
                ...
                echo "                        <tr>\n";
                echo "                              <td>\n";
                echo "                                   <a href=\"".$_SESSION['settings']['url_to_rms']."$sessionlink\" class=\"sessionlinkurl\" target=\"_blank\">$sessionlink</a>\n";
                echo "                              </td>\n";
                echo "                              <td>\n";
                ...
                echo "                                  sessionlinkPos = jQuery.inArray(\"$sessionlink\", mySessionlink);\n";
                echo "                                  if (sessionlinkPos != -1) {\n";
                echo "                                      var removedelements = mySessionlink.splice(sessionlinkPos, 1);\n";
                echo "                                      $('#sessionlinklist_hidden').text(mySessionlink.toString());\n";
                echo "                                  }\n";
                echo "                              }\n";
                echo "                          }\n";
                echo "                      });\n";
...
function echoSessionForm()
{
    ...
    echo "                                      </td>\n";
    echo "                                      <td><div id=\"add_sessionlink\">add</div>\n";
    echo "                                      </td>\n";
    echo "                                  </tr>\n";
    echo "                                  <tr>\n";
