...
const SESSIONWEB_DB_LAYOUT_LATEST_SQL = "SessionwebDbLayout_1.2.sql";
const SESSIONWEB_DB_LAYOUT_1_0_SQL = "SessionwebDbLayout_1.0.sql";
const SESSIONWEB_DB_LAYOUT_DELTA_1_0_1_2_SQL = "SessionwebDbLayoutDelta_1.0-_1.2.sql";
const SESSIONWEB_LATEST_VERSION = "1.2";
