...
-- -----------------------------------------------------
-- Table `sessionwebos`.`settings_new`
-- -----------------------------------------------------
...
START TRANSACTION;
USE `sessionwebos`;
INSERT INTO `sessionwebos`.`settings` (`id`, `normalized_session_time`, `team`, `sprint`, `teamsprint`, `area`, `testenvironment`, `publicview`, `analyticsid`, `url_to_dms`, `url_to_rms`, `wordcloud`, `custom1`, `custom1_name`, `custom1_multiselect`, `custom2`, `custom2_name`, `custom2_multiselect`, `custom3`, `custom3_name`, `custom3_multiselect`) VALUES (NULL, 90, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `sessionwebos`;
INSERT INTO `sessionwebos`.`version` (`id`, `versioninstalled`) VALUES (NULL, 21);
