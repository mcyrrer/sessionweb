...
function getAttachmentFromDb($dbManager, $logger)
{
    ...
    $sql = "SELECT id, mission_versionid, filename, mimetype, size, data, thumbnail FROM `mission_attachments` WHERE `id` = " . $_GET['id'];
    ...
    $logger->debug("Attachment download:[$attachmentId] id:" . $dbId . " mission_versionid:" . $versionId . " filename: " . $filename . " mimetype: " . $mimeType . " size: " . $size, __FILE__, __LINE__);
    return array($attachmentId, $filename, $mimeType, $size, $data);
}
