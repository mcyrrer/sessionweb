...
class Areagridreport
{
    ...
    function __construct()
    {
        ...
        $this->con = $this->dbh->connectToLocalDb();
...
//        }
    ...
    private function getAreaGridReportStatisticIntoGridHtml($allSessions)
    {
        ...
        $allApplicationsBasedOnAreaName = DataManipulater::getApplicationsFromAreaNames();
        ...
        $allAreas = QueryHelper::getAreasFromAreaTable();
