...
//        $result = mysqli_query($con, $sqlSelect);
    ...
    function swCreateNewSessionId()
    {
        ...
        $con = $this->dbm->connectToLocalDb();
        /** @noinspection PhpVoidFunctionResultUsedInspection */
        $result = $this->dbm->executeQuery($con, $sqlInsert);
...
//            $this->logger->debug($sql,__FILE__,__LINE__);
    ...
    function toArray()
    {
        ...
        $sessionDataAsArray['fullusername'] = $this->fullusername; //Text
...
//            $this->logger->debug($json,__FILE__,__LINE__);
    ...
    function deleteFromDatabase()
    {
        ...
        $this->dbm->executeQuery($con, $sqlDeleteMissionMetrics);
        ...
        $this->dbm->executeQuery($con, $sqlDeleteMissionRequirements);
        ...
        $this->dbm->executeQuery($con, $sqlDeleteMissionConnectionsFrom);
